...
\titulo{Missões NanosatC-Br1 e OSIRIS-REx}
\title{XXXX}
%% coloque o nome do(s) autor(es)
\author{Aluno: Eduardo Furlan Miranda}
\descriccao{CAP382 Tópicos em Tecnologias Espaciais}
...
\cutterFICHAC{Cutter}
\autorUltimoNomeFICHAC{xxxx} %% exemplo: Fuckner, Marcus André
...
\paginasFICHAC{\pageref{NumeroDePaginasDoPretexto} + \pageref{LastPage}} %% número total de páginas
%\serieinpe{INPE-00000-TDI/0000} %% não mais usado
\palavraschaveFICHAC{1.~xxxx. 2.~xxxx 3.~xxxx. 4.~xxxx. I.~\mbox{Título}.} %% recomenda-se pelo menos 5 palavras-chaves - \mbox{} é para evitar hifenização
\numeroCDUFICHAC{000.000} %% número do CDU

% Nota da ficha (para TD)
\tipoTD{xxxx} % Dissertação ou Tese
\cursoFA{xxxx}
...
\valorAtributoOrientadorFICHAC{xxxx} % nome(s) completo(s)

%%%%%%%%%%%%%%%FOLHA DE APROVAÇAO PELA BANCA EXAMINADORA
\tituloFA{ATENÇÃO! A FOLHA DE APROVAÇÃO SERÁ INCLUÍDA POSTERIORMENTE.}
